              ...
              <div className="container-fluid">
                  <div className="row">
                      <div className="col-lg-2 ml-auto">
                          ...
                          <div className="social-section text-md-left">
                              <ul className="text-center">
                                  <li>
                                      <a href="https://google.com"  className="btn-floating  btn-fb waves-effect waves-light">
                                          <i className="fa fa-facebook"></i>
                                      </a>
                                  </li>
                                  <li>
                                      <a href="https://google.com"  className="btn-floating  btn-ins waves-effect waves-light">
                                          <i className="fa fa-instagram"></i>
                                      </a>
                                  </li>
                                  <li>
                                      <a href="https://google.com"  className="btn-floating  btn-tw waves-effect waves-light">
                                          <i className="fa fa-twitter"></i>
                                      </a>
                                  </li>
                                  <li>
                                      <a href="https://google.com"  className="btn-floating  btn-yt waves-effect waves-light">
                                          <i className="fa fa-youtube"></i>
                                      </a>
                                  </li>
                                  <li>
                                      <a href="https://google.com"  className="btn-floating  btn-li waves-effect waves-light">
                                          <i className="fa fa-linkedin"></i>
                                      </a>
                                  </li>
                                  <li>
                                      <a href="https://google.com"  className="btn-floating  btn-dribbble waves-effect waves-light">
                                          <i className="fa fa-dribbble left"></i>
                                      </a>
                                  </li>
                                  <li>
                                      <a href="https://google.com"  className="btn-floating  btn-pin waves-effect waves-light">
                                          <i className="fa fa-pinterest"></i>
                                      </a>
                                  </li>
                                  <li>
                                      <a href="https://google.com"  className="btn-floating  btn-gplus waves-effect waves-light">
                      ...
                      <div className="col-lg-2">
                          ...
                          <ul>
                              <li>
                                  <a href="https://google.com" >Store Delivery</a>
                              </li>
                              <li>
                                  <a href="https://google.com" >Online Delivery</a>
                              </li>
                              <li>
                                  <a href="https://google.com" >Delivery Terms &amp; Conditions</a>
                              </li>
                              <li>
                                  <a href="https://google.com" >Tracking</a>
                              </li>
                          </ul>
                      </div>
                      <div className="col-lg-2">
                          ...
                          <ul>
                              ...
                              <li>
                                  <a href="https://google.com" >Return Policy</a>
                              </li>
                              <li>
                                  <a href="https://google.com" >Product Registration</a>
                              </li>
                          </ul>

          ...
          <header>
              <ul id="slide-out" className="side-nav hidden custom-scrollbar sn-bg-2 ps ps--theme_default" data-ps-id="c27390a3-9efc-e0d8-197a-ab96d73a156a">
                  ...
                  <li>
                      <ul className="social">
                          <li>
                              <a href="https://google.com" className="icons-sm fb-ic">
                                  <i className="fa fa-facebook"> </i>
                              </a>
                          </li>
                          <li>
                              <a href="https://google.com" className="icons-sm pin-ic">
                                  <i className="fa fa-pinterest"> </i>
                              </a>
                          </li>
                          <li>
                              <a href="https://google.com" className="icons-sm gplus-ic">
                                  <i className="fa fa-google-plus"> </i>
                              </a>
                          </li>
                          <li>
                              <a href="https://google.com" className="icons-sm tw-ic">
                  ...
                  <li>
                      ...
                      <ul className="collapsible collapsible-accordion">
                          <li>
                              <a href="https://google.com" className="collapsible-header waves-effect arrow-r">
                          ...
                          <li className="active">
                              <a href="https://google.com" className="collapsible-header waves-effect arrow-r active">
              ...
              <nav className="navbar fixed-top navbar-toggleable-md navbar-expand-lg navbar-dark scrolling-navbar double-nav">
                  ...
                  <div className="float-left">
                      <a href="https://google.com"  data-activates="slide-out" className="button-collapse">
                  ...
                  <ul className="nav navbar-nav nav-flex-icons ml-auto">
                      <li className="nav-item dropdown">
                          <a href="https://google.com"  className="nav-link dropdown-toggle waves-effect waves-light" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true"
                              aria-expanded="false">
                              <i className="fa fa-user"></i> Tài Khoản</a>
                          <div className="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu1">
                              <a href="https://google.com"  className="dropdown-item waves-effect waves-light">Đăng Ký</a>
                              <a href="https://google.com"  className="dropdown-item waves-effect waves-light">Đăng Nhập</a>
                              <a href="https://google.com"  className="dropdown-item waves-effect waves-light">Đăng Xuất</a>
                          </div>
                      </li>
                  </ul>
